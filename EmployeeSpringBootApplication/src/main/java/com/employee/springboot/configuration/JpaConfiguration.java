package com.employee.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.employee.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.employee.springboot.model" });
